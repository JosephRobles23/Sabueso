export { InvestigatorAvatar } from "./InvestigatorAvatar";
export type {
  InvestigatorAvatarProps,
  AvatarVisualState,
  AvatarSize,
} from "./InvestigatorAvatar";

export { InvestigatorWorkstation } from "./InvestigatorWorkstation";
export type { InvestigatorWorkstationProps } from "./InvestigatorWorkstation";

export { DelegationArrow } from "./DelegationArrow";
export type { DelegationArrowProps, DelegationStatus, Point } from "./DelegationArrow";
